...
{
    public class TasknoteMV : Tasknote
    {
        public static async Task<ReturnResult> SelectById(long id)
        {
            try
            {
                ...
                TasknoteMV oTasknoteMV = ObjectManipulation.CastObject<TasknoteMV>(await db.Tasknotes.FirstAsync(c => c.Id == id));
                return new ReturnResult(true, "", oTasknoteMV);
            }
            catch (Exception ex)
            {
        ...
        public static async Task<ReturnResult> SelectAll()
        {
            ...
            {
                using QerpContext db = new QerpContext();
                List<TasknoteMV> lstTasknoteMV = ObjectManipulation.CastObject<List<TasknoteMV>>(await db.Tasknotes.ToListAsync());
                return new ReturnResult(true, "", lstTasknoteMV);
            }
            catch (Exception ex)
            {
                return new ReturnResult(false, ex.Message, null);
